...
?>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4" class="col-form-label">Names</label>
                                        <input type="text" class="form-control" id="adminname" name="adminname" placeholder="" value="<?php  echo $row['Names'];?>">
                                    </div>
                                    <div class="form-group col-md-12">
