...
if (strlen($_SESSION['crmsaid']==0)) {
  header('location:logout.php');
   ...
   echo "<script>window.location.href='total-regusers.php'</script>";
}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card my-3 no-b">
                    <div class="card-body">
                        <div class="card-title">Registered Candidate</div>
...
?>
                  ...
                  <td><a href="view-users-details.php?viewid=<?php echo $row['ID'];?>"class='btn btn-primary '>View Details</a></td>
                  <td><a href="total-regusers.php?del=<?php echo $row['ID'];?>" onclick="return confirm('Do you really want to delete ?')" style="color: #f05050"class="btn btn-danger"  tooltip-placement="top" tooltip="Remove">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
