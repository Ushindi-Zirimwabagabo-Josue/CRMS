...
if (strlen($_SESSION['crmscid']==0)) {
  ...
  {
     //$to = $_GET['Email'];
    // $from = "yannick@gmail.com";
        $to  = "astrud2@gmail.com";
...
<textarea name="message" placeholder="Message" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
 ...
 <div class="modal-footer">
  ...
  <!-- <input type="text" hidden="true" name="mailto" value="<?php echo $row['Email'];?>" > -->

 <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
   <button type="submit" name="submit" class="btn btn-primary" <?php echo $row['submit']?>
     >Update</button>  
  </form>
