 <header>
                    <div class="top-head ml-lg-auto text-center">
                        <div class="row">
                            ...
                            <div class="col-md-4" Style="margin:10px 0px 2px 80px;">
...
<?php
 ...
 if($_SESSION['crmsuid']==0){?>
                            ...
                            <div class="nav-item dropdown" Style="margin-left:18px;">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  
                                        <i class="far fa-user"></i>   Account
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="user/login.php"style="color:black;">Candidate</a>
                                    <a class="dropdown-item" href="company/login.php"style="color:black;"> Employers</a>
                                        <a class="dropdown-item" href="admin/login.php"style="color:black;">Admin</a>
...
<?php
 ...
 if($_SESSION['crmsuid']==0){?>
                                <!-- <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="user/login.php">Candidate</a>
                                    <a class="dropdown-item" href="company/login.php"> Employers</a>
